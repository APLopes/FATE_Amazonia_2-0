...
|------|-------------|-------------|
| `Figure1_map.jpg` | Figure 1 Box a --- Burned area map (2020) | GEE `Paper_fig1_map.js` |
| `Figure1.png` | Figure 1 Boxes b-d --- Deforestation of burned forests | Script 1 |
| `Figure2.png` | Figure 2 --- AGB change following fire | Script 2 |
| `Figure3.png` | Figure 3 --- GHG emissions from forest fires | Script 3 |
| `Figure1_boxb_axis1_data.xlsx` | Source data --- Figure 1 Box b | Script 1 |
| `Figure1_boxb_axis2_data.xlsx` | Source data --- Figure 1 Box b | Script 1 |
| `Figure1_boxc_data.xlsx` | Source data --- Figure 1 Box c | Script 1 |
| `Figure1_boxd_data.xlsx` | Source data --- Figure 1 Box d | Script 1 |
| `Figure3_data.xlsx` | Source data --- Figure 3 emissions | Script 3 |
