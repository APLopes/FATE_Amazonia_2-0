...
// --- --- --- VERSION
// var version = 'v2-1'; // commit 14 Apr 2023 - from mapbiomas-fire-collection2 1985-2022 annual data
// var version = 'v2-2'; // commit 11 May 2023 - from mapbiomas-fire-collection2 slice 2001-2022 annual data
// var version = 'v2-3' + '-nasa-mcd64a1-v6-2001to2022'; // commit 11 May 2023 -    from nasa mcd64a1 v6 slice 2001-2022 annual data
// var version = 'v2-3-1' + '-nasa-mcd64a1-v6-2001to2022-legacy-to2038'; // commit 14 May 2023 -    from nasa mcd64a1 v6 slice 2001-2022 annual data, plus legacy to 2038
var version = 'v2-2-1' + '-mapbiomas-fire-collection2-2001to2022-legacy-to2038'; // commit 14 May 2023 -    from mapbiomas-fire-collection2 slice 2001-2022 annual data, plus legacy to 2038

// --- --- --- ASSETS 
var time_since_fire = ee.Image('projects/ee-seegfiredyn/assets/mapbiomas-fire-collection2-time-after-fire-v1-2002to2023'),
    ...
    annual_fire = ee.Image('projects/mapbiomas-workspace/FOGO/COLLECTIONS/COL02/SUBPRODUTOS/mapbiomas-fire-collection2-annual-burned-coverage-v1').slice(16).selfMask(),
    frequence_fire = ee.Image(
      ee.List.sequence(0,21,1) // 21 = 2022 - 2001
    ...
    postYearsScars.forEach(function(year){
      ...
      frequence_fire = frequence_fire.addBands(
        frequence_fire.select(21).rename('fire_frequency_1985_' + year)
        );
      
      time_since_fire = time_since_fire.addBands(
        time_since_fire.select('classification_'+year).add(1).rename('classification_'+(year+1))
        );
...
list_biomes.forEach(function(biome){
  ...
  var first = ee.Image().rename('fLeftAGB_2001')
    .addBands(ee.Image().rename('fLeftAGN_2001'));
