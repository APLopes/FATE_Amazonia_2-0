...
##
## APL: version called "SEEGFire_AM_Burnedforests_deforestation_analyses_20230110.R" in my PC
...
file = 'C:/Users/liepl/OneDrive - inpe.br/IPAM/Codes/Desm_freq_queima/Burnedforests_deforestation_20230109/burn_desf_area.csv'
...
file2 = 'C:/Users/liepl/OneDrive - inpe.br/IPAM/Codes/Desm_freq_queima/Burnedforests_deforestation_20230109/burn_std_for_area.csv'
...
df.list3.freq$freq_desf = as.factor(df.list3.freq$freq_desf)
...
df.list3.freq$freq_num = as.numeric(levels(df.list3.freq$freq_desf))[df.list3.freq$freq_desf]
...
df.list3.freq_summary = df.list3.freq %>%
...
df.list3.freq_summary = as.data.frame(df.list3.freq_summary)
df.list3.freq_summary$year = as.numeric(df.list3.freq_summary$year) + 1989
df.list3.freq_summary$sd_up = df.list3.freq_summary$wg_avg_freq + df.list3.freq_summary$wg_sd_freq
df.list3.freq_summary$sd_lo = df.list3.freq_summary$wg_avg_freq - df.list3.freq_summary$wg_sd_freq
...
df.list6.freq$freq_std = as.factor(df.list6.freq$freq_std)
df.list6.freq$year = as.factor(df.list6.freq$year)

rm(i, temp, path2, file.list4.freq, df.list5.freq)

df.list6.freq$freq_num = as.numeric(levels(df.list6.freq$freq_std))[df.list6.freq$freq_std]

df.list6.freq_summary = df.list6.freq %>%
  group_by(status, year) %>%
  summarize(total_area = sum(area_km2,na.rm = T),
            wg_avg_freq = weighted.mn(x=freq_num, w=area_km2,na.rm=T),
            wg_sd_freq = weighted.sd(x=freq_num, w=area_km2))

df.list6.freq_summary = as.data.frame(df.list6.freq_summary)
df.list6.freq_summary$year = as.numeric(df.list6.freq_summary$year) + 1989
df.list6.freq_summary$sd_up = df.list6.freq_summary$wg_avg_freq + df.list6.freq_summary$wg_sd_freq
df.list6.freq_summary$sd_lo = df.list6.freq_summary$wg_avg_freq - df.list6.freq_summary$wg_sd_freq

# joining both dataframes

df.freq_bd_bs_summary = rbind(df.list3.freq_summary, df.list6.freq_summary)
...
path3 = 'C:/Users/liepl/OneDrive - inpe.br/IPAM/Codes/Desm_freq_queima/Burnedforests_deforestation_20230109/ysf_desf_yyyy'
...
df.list3.ysf$ysf_desf = as.factor(df.list3.ysf$ysf_desf)
df.list3.ysf$year = as.factor(df.list3.ysf$year)
...
df.list3.ysf$ysf_num = as.numeric(levels(df.list3.ysf$ysf_desf))[df.list3.ysf$ysf_desf]

df.list3.ysf_summary = df.list3.ysf %>%
  group_by(status, year) %>%
  summarize(total_area = sum(area_km2,na.rm = T),
            wg_avg_ysf = weighted.mn(x=ysf_num, w=area_km2,na.rm=T),
            wg_sd_ysf = weighted.sd(x=ysf_num, w=area_km2))

df.list3.ysf_summary = as.data.frame(df.list3.ysf_summary)
df.list3.ysf_summary$year = as.numeric(df.list3.ysf_summary$year) + 1989
df.list3.ysf_summary$sd_up = df.list3.ysf_summary$wg_avg_ysf + df.list3.ysf_summary$wg_sd_ysf
df.list3.ysf_summary$sd_lo = df.list3.ysf_summary$wg_avg_ysf - df.list3.ysf_summary$wg_sd_ysf
df.list3.ysf_summary$sd_lo = ifelse(df.list3.ysf_summary$sd_lo < 0, 0, df.list3.ysf_summary$sd_lo)
...
#df.list6.ysf = subset(df.list6.ysf, ysf_std>0)
df.list6.ysf$ysf_std = as.factor(df.list6.ysf$ysf_std)
df.list6.ysf$year = as.factor(df.list6.ysf$year)

rm(i, temp, path4, file.list4.ysf, df.list5.ysf)

#summary 

df.list6.ysf$ysf_num = as.numeric(levels(df.list6.ysf$ysf_std))[df.list6.ysf$ysf_std]

df.list6.ysf_summary = df.list6.ysf %>%
  group_by(status, year) %>%
  summarize(total_area = sum(area_km2,na.rm = T),
            wg_avg_ysf = weighted.mn(x=ysf_num, w=area_km2,na.rm=T),
            wg_sd_ysf = weighted.sd(x=ysf_num, w=area_km2))

df.list6.ysf_summary = as.data.frame(df.list6.ysf_summary)
df.list6.ysf_summary$year = as.numeric(df.list6.ysf_summary$year) + 1989
df.list6.ysf_summary$sd_up = df.list6.ysf_summary$wg_avg_ysf + df.list6.ysf_summary$wg_sd_ysf
df.list6.ysf_summary$sd_lo = df.list6.ysf_summary$wg_avg_ysf - df.list6.ysf_summary$wg_sd_ysf
df.list6.ysf_summary$sd_lo = ifelse(df.list6.ysf_summary$sd_lo < 0, 0, df.list6.ysf_summary$sd_lo)

# joining both dataframes

df.ysf_bd_bs_summary = rbind(df.list3.ysf_summary, df.list6.ysf_summary)
...
# without standing forests
# as .png
png("./figures/Manuscript_Figure_Burned_Deforestation_20230320_full.png",
...
ggsave(file="./figures/Manuscript_Figure_Burned_Deforestation_20230320_full.svg", 
