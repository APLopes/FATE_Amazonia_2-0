...
# "SEEGFire_SA_1.3_Model_output_Multiburn_ManuscriptFigure_20220324.R"
load('SEEGmodel_20220404.Rdata')
...
png("./figures/Manuscript_Sup_Figure_FireFreq_Interval_Heatmap_20220524.png", 
...
# png("./figures/SEEGFire_AM_IntModel_SAnalysis_Summary_CombF_cwd_20220427.png", 
...
# # plotting teh same frequencies and different intervals
# 
