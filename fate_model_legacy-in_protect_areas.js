...
// --- --- --- VERSION
var version = 'v2-4-1-AP-legacy'; // commit 23 May 2023 -    from nasa mcd64a1 v6 slice 2001-2022 annual data
// --- --- --- ASSETS
...
var annual_fire_freq_gte2 = annual_fire.updateMask(frequence_fire.gte(2)).gte(1),
    ...
    protect_areas = ee.Image('projects/mapbiomas-workspace/AUXILIAR/areas-protegidas-por-ano-2022/ap2022');
...
list_biomes.forEach(function(biome){
  ...
  data = ee.Image(data)
    ...
    .updateMask(protect_areas.eq(1)); // mascarando para as areas protegidas
